...
public final class Config {
	...
	public static String PET_RATE_XP;// TODO管理者介面byeric1300460
	...
	public static int PET_LEVEL;// TODO 能力值上限調整 by 阿傑

	public static int REVIVAL_POTION;// TODO 能力值上限調整 by 阿傑
	...
	public static boolean ALT_REVIVAL_POTION;// TODO 轉生血魔保留
	...
	private static void loadInfo() {
		try {
			...
			logSettings.load(is);
			is.close();
			REVISION = Integer.parseInt(logSettings.getProperty("Revision",
					"1846"));
			EDIT_DATE = logSettings.getProperty("Date", "2009/06/06");

			_systemInfo = new String[] {
					"===========================================================",
					" 模 擬 器 版 本 Revision r" + REVISION + " 編 輯 日 期 "
							+ EDIT_DATE + ".", " ",
	...
	public static void load() {
		...
		try {
			...
			// TODO 伺服器重啟 by 阿傑
			REST_TIME = Integer.parseInt(altSettings.getProperty("RestartTime",
					"60"));
			// TODO 殷海薩的祝福
			...
			// TODO ＧＭ使用公頻(&)顯示方式 2/3
			// TODO 所有物品販賣開關
			AllSell = Boolean.parseBoolean(altSettings.getProperty("AllSell",
					"true"));
			...
			Use_Show_Announcecycle = Boolean.parseBoolean(altSettings
					.getProperty("UseShowAnnouncecycle", "false")); // 循環公告 2/3
																	// by 丫傑
			Show_Announcecycle_Time = Integer.parseInt(altSettings.getProperty(
		...
		try {
			...
			BONUS_STATS3 = Integer.parseInt(charSettings.getProperty(
					"BONUS_STATS3", "25"));
			PET_LEVEL = Integer.parseInt(charSettings.getProperty("Pet_Level",
					"51"));
	...
	public static boolean setParameterValue(String pName, String pValue) {
		...
		// altsettings.properties
			...
			Use_Show_Announcecycle = Boolean.valueOf(pValue); // TODO 循環公告 3/3
																// by 丫傑
		} else if (pName.equalsIgnoreCase("ShowAnnouncecycleTime")) {
			Show_Announcecycle_Time = Integer.parseInt(pValue); // TODO 循環時間 3/3
																// by 丫傑
