...
public class S_InitialAbilityGrowth extends ServerBasePacket {
	public S_InitialAbilityGrowth(L1PcInstance pc) {
		...
		int Str = pc.getOriginalStr();// TODO 力量
		int Dex = pc.getOriginalDex();// TODO 敏捷
		int Con = pc.getOriginalCon();// TODO 體質
		int Wis = pc.getOriginalWis();// TODO 精神
		int Cha = pc.getOriginalCha();// TODO 魅力
		int Int = pc.getOriginalInt();// TODO 智力
	...
	private void buildPacket(L1PcInstance pc, int Str, int Dex, int Con,
		...
		writeC(121);
		writeC(0x04);
		writeC(write1);// TODO 智力&力量
		writeC(write2);// TODO 敏捷&精神
		writeC(write3);// TODO 魅力&體質
		writeC(0x00);
	}
