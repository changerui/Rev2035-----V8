...
import l1j.server.server.model.Instance.L1DollInstance; //TODO 經驗加倍魔法娃娃 by hot183 
...
public class CalcExp {
	...
	private static void AddExp(L1PcInstance pc, int exp, int lawful) {
		...
		// TODO 經驗加倍魔法娃娃
		Object[] dollList = pc.getDollList().values().toArray(); // マジックドールによる追加ダメージ
		...
		if (pc.getAinPoint() > 0) {
			if (!(_npc instanceof L1PetInstance
					|| _npc instanceof L1SummonInstance || _npc instanceof L1ScarecrowInstance)) {// 木人
																									// 寵物
																									// 召喚
																									// 不計算加成
